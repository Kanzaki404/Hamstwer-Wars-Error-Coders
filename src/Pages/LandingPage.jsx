...
const LandingPageStyle = styled.div`
  ...
  height: 91vh;
  text-align: center;
  background-image: url(${({ hovering }) =>
    hovering === false ? img1 : img2});
...
const GoHamText = styled.div`
  ...
  @keyframes drop {
    ...
    80%,
    100% {
      transform: translateY(5vh) scaleX(0.85) rotate(45deg);
    }
  }
`;
    ...
    <LandingPageStyle hovering={hovering}>
      <div className="info-text">
        <div className="text">
          ...
          <p className="welcome">
            Welcome <span className="small">to</span>{' '}
            <span className="darker">GoHam!</span>
          </p>

          <p className="goham-text">
            <span> GoHam</span> Arena hosts the <span>bloodiest</span>, most{' '}
            <span>intense</span> and <span>adorable</span> voting{' '}
            <span>Battles</span> in the Cosmos!
            <br></br>
            In the early year of 2020, GoHam was created for its purpose for
            bringing All hamster lovers together to witness the glory of you and
            other powerful Hamster Warriors in action!
            <br></br>
            <br></br>
