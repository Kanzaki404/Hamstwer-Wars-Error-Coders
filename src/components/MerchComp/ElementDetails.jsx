    ...
    <div className="App">
      ...
      <div className="mains">
        <div className="firstPart">
          <div>
            <img src={todos.im} alt="itemImage"></img>
          </div>
        </div>
        ...
        <div className="secondPart">
          ...
          <p>
            This shirt will bring fear to your enemies and bring <br /> harmony
            to your friends, wear it wisely hamster...
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <label id="labForProduct">Size:</label>
            <span></span>
            ...
            <button
              ...
              name="sub"
            >
              Add To Cart<img className="buttonStyleI" src={cartImage}></img>
            </button>
          </form>
        </div>
      </div>
      ...
      <div className="footer">
        <div onClick={onBack}>
          <div className="back-page">
            <img className="img" src={imageBackward} alt="noImg" />
            <h2 className="text">Shop More/Go Back</h2>
          </div>
        </div>
      </div>
    </div>
